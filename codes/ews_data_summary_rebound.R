...
#length(t1)=14
if(k==1) ii<-c(2, 6,  8,  9, 16, 19, 20, 24) # NGRIP d18O
if(k==2) ii<-c(6,  8,  9, 16, 19, 20, 24)    # GRIP d18O
if(k==3) ii<-c(6,  8,  9, 16, 19, 20, 24)    # GISP2 d18O
if(k==4) ii<-c(6,  8,  9, 16, 19, 20, 24)    # NGRIP ca2+
if(k==5) ii<-c(6,  8,  9, 16, 19, 20, 24)    # GRIP ca2+
if(k==6) ii<-c(6,  8,  9, 16, 19, 20, 24)    # GISP2 ca2+
...
## plot ############################################################################
for(iii in 1:2){
if(k==1 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_NGRIP_d18O_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==1 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_NGRIP_d18O_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==2 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GRIP_d18O_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==2 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GRIP_d18O_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==3 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GISP2_d18O_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==3 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GISP2_d18O_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==4 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_NGRIP_ca_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==4 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_NGRIP_ca_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==5 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GRIP_ca_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==5 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GRIP_ca_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==6 && iii==1) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GISP2_ca_1.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
if(k==6 && iii==2) postscript(file="ews_data_summary_rebound/ews_data_summary_rebound_GISP2_ca_2.eps", onefile=FALSE, horizontal=FALSE,encoding="WinAnsi.enc")
...
filename<-paste("ews_data_summary_rebound/result",k,".dat",sep="")
