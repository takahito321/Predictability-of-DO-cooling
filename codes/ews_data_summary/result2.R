...
rect(0.5, 0.5, 1.5, 5.5, density = 50, col = "gray", angle = -30, border = "transparent")
rect(0.5, 6.5, 1.5, 11.5, density = 50, col = "gray", angle = -30, border = "transparent")
text(1,9,"Unpublished",cex=1.5,srt=90)
text(1,3,"Unpublished",cex=1.5,srt=90)
title("(a) With rebound events",cex.main=1.4,col=1,xpd = NA,line = 1) 
dev.off()


sum(p[ii,]>=15) # number of robust EWS over 86 (12*8-10) combinations
